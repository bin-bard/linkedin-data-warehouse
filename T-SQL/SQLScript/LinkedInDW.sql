...
GO
ALTER TABLE dbo.DimLocation ADD LocationStringNormalized AS (ISNULL(LocationString, 'NULL'));
ALTER TABLE dbo.DimLocation ADD ZipCodeNormalized AS (ISNULL(ZipCode, 'NULL'));
ALTER TABLE dbo.DimLocation ADD FIPSNormalized AS (ISNULL(FIPS, 'NULL'));
GO
...
GO
CREATE UNIQUE INDEX IDX_DimSpeciality_NK_Current ON dbo.DimSpeciality (SpecialityName, IsCurrent);
CREATE INDEX IDX_DimSpeciality_NK_History ON dbo.DimSpeciality (SpecialityName, ValidFrom, ValidTo);
GO
...
CREATE TABLE dbo.DimJob (
    ...
    OriginalListedTime_raw FLOAT,
    ListedTime_raw FLOAT,
    Expiry_raw FLOAT,
    ClosedTime_raw FLOAT,
...
CREATE TABLE dbo.FactJobPosting (
    ...
    MedSalary DECIMAL(18,2),
    NormalizedSalary DECIMAL(18,2),
    job_df_MaxSalary DECIMAL(18,2),
    job_df_MinSalary DECIMAL(18,2),
    job_df_MedSalary DECIMAL(18,2),
    job_df_PayPeriod NVARCHAR(50),
    job_df_Currency NVARCHAR(10),
    job_df_CompensationType NVARCHAR(50),
    job_df_NormalizedSalary DECIMAL(18,2),
